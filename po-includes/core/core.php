	...
	*/
	public function setlang($component, $lang)
	{
		if (file_exists("po-content/lang/".$component."/".$lang.".php")) {
			...
			if (VQMOD == TRUE) {
				include_once VQMod::modCheck("po-content/lang/main/hu.php");
				include_once VQMod::modCheck("po-content/lang/".$component."/hu.php");
				return $_;
			} else {
				include_once "po-content/lang/main/hu.php";
				include_once "po-content/lang/".$component."/hu.php";
				return $_;
			}
		}
	}
