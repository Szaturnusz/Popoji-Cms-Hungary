		...
		if (file_exists("../".DIR_CON."/component/".strtolower($mod)."/admin_".strtolower($mod).".php")) {
			...
			if (class_exists($mod)) {
				if (file_exists("../".DIR_CON."/lang/".strtolower($mod)."/".$selectlang.".php")) {
					...
					if (file_exists("../".DIR_CON."/lang/".strtolower($mod)."/hu.php")) {
						if (VQMOD == TRUE) {
							include_once VQMod::modCheck("../".DIR_CON."/lang/".strtolower($mod)."/hu.php");
						} else {
							include_once "../".DIR_CON."/lang/".strtolower($mod)."/hu.php";
						}
					}
				}
				$slug = new $mod();
